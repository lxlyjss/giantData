$(function (){
    ...
    $.fn.getAndShow = function (userId){
        ...
        function getAjaxData(userId,date){
            $.ajax({
                url:"http://192.168.9.20:8080/giantService/userData/userChange",
                ...
                success:function (data){
                    ...
                    if(resultData.result == 1 && resultData.data != null){
                        showData(resultData);
                    }else{
                        alert("数据返回失败!result=0或数据为空");
                    }
                },
        ...
        function defaultData(){
            vipCountData.xAxis.data = [];
            vipCountData.series[0].data = [];
            vipCountData.legend.data = ["累计用户"];
            optionData.legend.data = [];
            optionData.xAxis.data = [];
            optionData.series[0].data = [];
        }
        //拆分数据
